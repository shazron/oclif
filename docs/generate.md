...
_See code: [src/commands/generate.ts](https://github.com/oclif/oclif/blob/4.23.28/src/commands/generate.ts)_
...
_See code: [src/commands/generate/command.ts](https://github.com/oclif/oclif/blob/4.23.28/src/commands/generate/command.ts)_
...
_See code: [src/commands/generate/hook.ts](https://github.com/oclif/oclif/blob/4.23.28/src/commands/generate/hook.ts)_
